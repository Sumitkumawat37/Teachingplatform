...
import { MessageCircle, Send, Lock as LockIcon } from "lucide-react";
import { toast } from "sonner";

const AdminDoubts = () => {
  // Lock: Doubt management is disabled
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0a0a1a]">
      <div className="text-center p-8">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Doubt Management Locked</h2>
        <p className="text-gray-400">Doubt replies and management is currently disabled.</p>
      </div>
    </div>
  );
