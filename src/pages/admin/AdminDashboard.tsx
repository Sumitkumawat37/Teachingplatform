    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <Card className="p-6 bg-card border border-border shadow-sm">
        ...
        <div className="space-y-3">
          {studentProfiles.slice(0, 4).map((student, idx) => (
            <div key={student.user_id || student.id || idx} className="flex items-center gap-4 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
